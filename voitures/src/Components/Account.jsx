    ...
    return (
        <section className="bg-light py-5">
            <Container>
                ...
                <Form className="border col-12 col-md-8 col-lg-4 m-auto pb-5 px-4 py-3" style={{ borderRadius: "10px" }} autoComplete="off" onSubmit={handleSubmit}>
                    ...
                    <Form.Control disabled={true} value={values.email} onChange={handleChange} onBlur={handleBlur} type="email" className="py-2 my-3" placeholder="E-mail" name="email" />
                    ...
                    <Form.Control type="submit" disabled={isSubmitting} className="btn-submit" value="Changer du Compte" />
                </Form>
            </Container>
        </section>
    );
